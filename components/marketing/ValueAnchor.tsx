  ...
  return (
    <section className="border-b border-zinc-200/80 bg-primary/10 py-10">
      <div className="mx-auto max-w-6xl px-4 text-center">
        <p className="text-sm text-mention-gray">Warum {offer}?</p>
        <p className="mx-auto mt-3 max-w-3xl text-xl font-semibold leading-snug text-mention-dark md:text-2xl">
