export function Weltbienentag2026Body() {
  return (
    <div className="mx-auto max-w-3xl px-4 pt-24 pb-16">
      <p className="mb-2 text-sm font-medium uppercase tracking-wide text-mention-dark">20. Mai – Weltbienentag</p>
      ...
      <div className="space-y-6 leading-relaxed text-mention-gray">
        <p>
          Heute ist Weltbienentag – und ein guter Moment, um innezuhalten. Bienen sind für unser Ökosystem fundamental.
          Hier sind 11 Fakten, die zeigen, wie faszinierend diese kleinen Wesen wirklich sind.
        </p>
        ...
        <div>
          ...
          <ol className="list-decimal space-y-4 pl-5">
            ...
            <li>
              Um 1 kg Honig zu produzieren, legen Bienen gemeinsam rund 40.000 km zurück – das entspricht einmal um die
              Erde. 🍯
            </li>
            <li>
            ...
            <li>
              Bienen schlafen. Forschungen zeigen, dass sie zwischen 5 und 8 Stunden pro Nacht ruhen – oft sogar in der
              Blüte. 💤
            </li>
            <li>
            ...
            <li>
              Bienen haben ein inneres GPS-System und finden dank Sonnenstand, Magnetfeld und Landmarken immer nach Hause.
              🕐
            </li>
            <li>
        ...
        <div>
          ...
          <p className="pt-2">
            <a href="https://mentionbee.ai" className="text-mention-dark font-semibold underline underline-offset-2">
